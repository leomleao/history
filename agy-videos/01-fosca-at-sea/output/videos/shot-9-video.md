# Video Production Dossier: Shot 9 (`shot-9-video.mp4`)

**Scene**: Shot 9 — The Coffee Plantation & The Living Roots (0:40 – 0:45)  
**Planned Target File**: `output/videos/shot-9-video.mp4`  
**Input Keyframe**: [`output/stills/shot-9-still-start.png`](file:///Users/leo/dev/history/agy-videos/01-fosca-at-sea/output/stills/shot-9-still-start.png)  
