# Video Production Dossier: Shot 7 (`shot-7-video.mp4`)

**Scene**: Shot 7 — Arrival at Capivari Station & Facing the Unknown (0:30 – 0:35)  
**Planned Target File**: `output/videos/shot-7-video.mp4`  
**Input Keyframe**: [`output/stills/shot-7-still.png`](file:///Users/leo/dev/history/agy-videos/01-fosca-at-sea/output/stills/shot-7-still.png)  
